...
## 문제 4. $n^{2}/(n+1)^{2} \to 1$ 인 교대급수 — 발산 확정
...
## 문제 6. $n!/(n+1)! = 1/(n+1)$ — 조화급수 형태, 추가 판정 필요
...
## 문제 7. 분모에 $\sqrt{n^{3}}$ 이 있는 교대급수 — 추가 판정 필요
...
## 문제 9. 지수항의 비 $3^{n}/(2^{n}+3^{n}) \to 1$ — 발산 확정
